	 ...
	 private final static String indexName = "bd-data";
	    ...
	    public static void main(String[] args) throws URISyntaxException, IOException {
	        Node node = nodeBuilder().settings(Settings.builder()
	            .put("cluster.name", "real-real-rupal1")
	            .put("path.home", "/Users/Macbook/Documents/CS594BIGDATA/elasticsearch-2.3.2/bin")).node();
	        ...
	        File csv = new File(
	            ClassLoader.getSystemResource("Data.csv")
	                .toURI());
	        ...
	        BulkProcessor bulkProcessor = BulkProcessor.builder(
	            ...
	            .setBulkSize(new ByteSizeValue(10000, ByteSizeUnit.GB))
...
//	        Terms agg1 = sr.getAggregations().get("us");
//
